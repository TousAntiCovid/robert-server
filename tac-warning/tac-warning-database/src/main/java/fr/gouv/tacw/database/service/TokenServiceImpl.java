...
public class TokenServiceImpl implements TokenService {
	private StaticTokenRepository staticTokenRepository;
	...
	public TokenServiceImpl(StaticTokenRepository staticTokenRepository) {
		super();
		this.staticTokenRepository = staticTokenRepository;
	}
