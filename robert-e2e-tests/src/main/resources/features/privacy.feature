...
Fonctionnalité: Respect des conditions générales sur l'usage des données
  ...
  Scénario: Les données d'exposition sont supprimées au bout de 15 jours
    Etant donné que Sarah a l'application TAC
    Et que John a l'application TAC
    Et que Sarah et John étaient à proximité 60 minutes il y a 15 jours et que John s'est déclaré malade
