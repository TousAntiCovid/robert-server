package fr.gouv.tac.e2e.appmobile;
...
import static fr.gouv.tac.e2e.appmobile.model.EcdhUtils.deriveKeysFromBackendPublicKey;
import static fr.gouv.tac.e2e.appmobile.model.EcdhUtils.generateKeyPair;
