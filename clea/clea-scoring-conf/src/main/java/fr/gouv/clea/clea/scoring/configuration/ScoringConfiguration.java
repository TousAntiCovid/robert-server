...
public class ScoringConfiguration {
    ...
    public boolean hasVenueTypeCompatibleWith(int venueType) {
        return this.getVenueType() == venueType || this.getVenueType() == ScoringConfiguration.wildcardValue;
    } 

    public boolean hasVenueCategory1CompatibleWith(int venueCategory1) {
        return this.getVenueCategory1() == venueType || this.getVenueCategory1() == ScoringConfiguration.wildcardValue;
    } 

    public boolean hasVenueCategory2CompatibleWith(int venueCategory2) {
        return this.getVenueCategory2() == venueType || this.getVenueCategory2() == ScoringConfiguration.wildcardValue;
    } 
