...
docker-compose -f docker-compose-orange-captcha.yml -v --env-file .env.local down
docker-compose -f docker-compose-proxy.yaml -v --env-file .env.local down
docker-compose -f docker-compose-robert-crypto.yml -v --env-file .env.local down
docker-compose -f docker-compose-robert-push.yml -v --env-file .env.local down
docker-compose -f docker-compose-robert-submission.yml -v --env-file .env.local down
docker-compose -f docker-compose-tacw.yml -v --env-file .env.local down
docker-compose -f docker-compose-robert-server.yaml -v --env-file .env.local down
