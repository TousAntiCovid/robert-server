...
public class TimestampedEventCollectionValidator implements ConstraintValidator<TimestampedEventCollection, Collection<TimestampedEventVo>> {
    ...
    private static final String TOO_MANY_ELEMENTS_ERROR_MESSAGE = "Too many %s, %d found, whereas the maximum allowed is %d";
    private static final String NAME_TOO_LONG_ERROR_MESSAGE = "For %s, name with more than %d characters is not allowed, found %d characters";
    private static final String DESCRIPTION_TOO_LONG_ERROR_MESSAGE = "For %s, description with more than %d characters is not allowed, found %d characters";
