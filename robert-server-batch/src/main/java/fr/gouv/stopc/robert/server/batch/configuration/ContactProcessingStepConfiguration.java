...
public class ContactProcessingStepConfiguration extends StepConfigurationBase {
    ...
    public ContactProcessingStepConfiguration(PropertyLoader propertyLoader, StepBuilderFactory stepBuilderFactory,
            ...
            ItemIdMappingService itemIdMappingService, MetricsService metricsService) {
    ...
    public Step contactWorkerStep(StepBuilderFactory stepBuilderFactory,
        ...
        return new StepExecutionListener() {
            ...
            public void beforeStep(StepExecution stepExecution) {
                ...
                stepExecution.getJobExecution().getExecutionContext()
                        .putLong(ScoringAndRiskEvaluationJobConfiguration.TOTAL_CONTACT_COUNT_KEY, totalItemCount);
            }
