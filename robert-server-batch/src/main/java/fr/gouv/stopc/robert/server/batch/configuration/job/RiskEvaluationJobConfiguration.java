...
/**
 * Only evaluate the risk of all registrations present in the database. WARNING:
 * old expositions MUST be purged before risk evaluation. If not, old
 * expositions scores will taken into account for risk evaluation.
 */
@Slf4j
@Configuration
@ConditionalOnProperty(value = "robert.scoring.batch-mode", havingValue = "FULL_REGISTRATION_SCAN_COMPUTE_RISK")
